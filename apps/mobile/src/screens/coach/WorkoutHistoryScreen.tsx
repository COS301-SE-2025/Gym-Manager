...
export default function WorkoutHistoryScreen() {
    ...
    const renderItem = ({ item }: { item: ApiClassWithWorkout }) => {
      ...
      return (
        <View style={s.card}>
          ...
          <Text style={s.subtle}>{dateStr} • {timeStr}</Text>
      ...
      <SafeAreaView style={s.container} edges={['top', 'left', 'right']}>
        ...
        {loading ? (
          ...
          <FlatList
            ...
            refreshControl={<RefreshControl refreshing={refreshing} onRefresh={onRefresh} tintColor="#D8FF3E" />}
          />
        )}
  ...
  const s = StyleSheet.create({
    ...
    pill: { color: '#1a1a1a', backgroundColor: '#D8FF3E', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 999, fontSize: 11, fontWeight: '700' },
