      ...
      <section className="hero">
        <div className="container hero-inner">
          ...
          <div className="hero-media">
            <Image className="hero-image" src="/gym1.jpg" alt="Trainwise HIIT studio" width={800} height={600} priority />
          </div>
        </div>
      </section>
      ...
      <section id="reasons" className="reasons">
        <div className="container">
          ...
          <div className="reason-grid">
            <ReasonCard title="Automated class scheduling" text="Build recurring HIIT timetables, waitlists and capacity rules in minutes." />
            <ReasonCard title="Memberships & passes" text="Create flexible passes and contracts with auto‑billing and proration." />
            <ReasonCard title="Integrated payments" text="Stripe-powered checkout, failed payment recovery and refunds built‑in." />
            <ReasonCard title="Real‑time attendance" text="QR/mobile check‑in, no‑shows, and live occupancy dashboards." />
          </div>
        </div>
      </section>
      ...
      <section id="membership" className="membership">
        <div className="container">
          ...
          <div className="card-grid">
            ...
            <MembershipCard name={'Enterprise'} price="Contact" benefits={[
      ...
      <section id="about" className="about">
        <div className="container about-grid">
          <div className="about-copy">
            ...
            <p>
              Built for high‑intensity studios, Trainwise reduces admin, improves retention and helps
              your team deliver exceptional member experiences across web and mobile.
            </p>
          </div>
          <div className="about-media">
            <Image className="about-image" src="/gym2.jpg" alt="Facility view" width={900} height={600} />
          </div>
        </div>
      </section>
      ...
      <footer className="footer">
        <div className="container footer-grid">
          <div className="footer-brand">
            ...
            <p>
              All‑in‑one HIIT gym management software: schedules, bookings, payments, CRM
              and analytics.
            </p>
          </div>
        </div>
...
function MembershipCard({ name, price, benefits }: { name: string; price: string; benefits: string[] }) {
  return (
    <div className="plan-card">
      ...
      <ul className="plan-list">
        {benefits.map((b) => (
          <li key={b}><span className="bullet" />{b}</li>
        ))}
      </ul>
...
function IconSpark() {
  return (
    <svg className="icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <path d="M12 2v4M12 18v4M4 12H0M24 12h-4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M4.93 19.07l2.83-2.83M16.24 7.76l2.83-2.83" stroke="#D8FF3E" strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
}
