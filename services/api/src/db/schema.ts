...
export const workoutType = pgEnum('workout_type', ['FOR_TIME', 'AMRAP', 'TABATA', 'EMOM']);
...
export const subrounds = pgTable(
  'subrounds',
  {
...
export const subroundExercises = pgTable(
  'subround_exercises',
  {
...
export const notificationTargets = pgTable(
  ...
  (table) => [
    ...
    primaryKey({
      columns: [table.notificationId, table.targetRole],
      name: 'notification_targets_pkey',
    }),
  ],
);
...
export const paymentTransactions = pgTable('payment_transactions', {
  ...
  packageId: integer('package_id')
    .notNull()
    .references(() => paymentPackages.packageId),
